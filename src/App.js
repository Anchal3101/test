...
function App() {
  ...
  function nameChangeHandler(e) {
    ...
    if (e.target.value === "") {
      ...
      nameError.children[0].children[0].innerText =
    ...
    if (e.target.value !== "" && isNaN(e.target.value) === false) {
      ...
      nameError.className = "d-block text-danger nameError";
      nameError.children[0].children[0].innerText =
        "Error: Name should not be a number";
      setStudentName("");
    }
  }
  ...
  function scoreChangeHandler(e) {
    ...
    let studentGrade =
      studentResult.nextSibling.nextSibling.nextSibling.nextSibling;
  ...
  function makeResultAndGradeColorfull(
    value,
    scoreError,
    studentResult,
    studentGrade
    ...
    <>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title fw-bold fs-5" id="exampleModalLabel">
                Add Student
              </h5>
              <button
                type="button"
              ...
              <form name="addStudent">
                <div className="mb-3">
                  ...
                  <input
                    ...
                    id="inp1"
                  />
                  <p id="nameError" className=" d-none text-danger">
                    <i>
                      <small>Error: Name field cannot be left blank.</small>
                    </i>
                  </p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <input
                    type="text"
                    name="classValue"
                    onChange={(e) => classChangeHandler(e)}
                    className="form-control "
                    id="inp2"
                  />
                  <p id="classError" className=" d-none text-danger">
                    <i>
                      <small>Error: Please enter value between 1 & 12</small>
                    </i>
                  </p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    id="inp3"
                  />
                  <p id="scoreError" className=" d-none text-danger">
                    <i>
                      <small>Error: Please enter value between 0 & 100</small>
                    </i>
                  </p>
                </div>

                <p style={{ fontSize: "12px", color: "#7F878A" }}>
                  <b>RESULT</b>
                </p>
                <p
                  id="studentResult"
            ...
            <div className="modal-footer">
              <button type="button" id="cancleButton" data-bs-dismiss="modal">
                Cancle
              </button>
              <button
                type="submit"
      ...
      >
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title fw-bold fs-5" id="exampleModalLabel2">
                Edit Student
              </h5>
              <button
                type="button"
              ...
              <form name="editStudent">
                <div className="mb-3">
                  ...
                  <input
                    ...
                    id="inp1"
                  />
                  <p id="nameError" className="d-none text-danger nameError">
                    <i>
                      <small>Error: Name field cannot be left blank.</small>
                    </i>
                  </p>
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    id="inp2"
                  />
                  <p id="classError" className="classError d-none text-danger">
                    <i>
                      <small>Error: Please enter value between 1 & 12</small>
                    </i>
                  </p>
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    name="score"
                    onChange={scoreChangeHandler}
                    className="form-control inp3"
                    id="inp3"
                  />
                  <p
                    id="scoreError i4"
                    className="scoreError d-none text-danger"
                  >
                    <i>
                      <small>Error: Please enter value between 0 & 100</small>
                    </i>
                ...
                <p
                  id="studentGrade"
                  className="studentGrade fw-bold"
                  style={{ fontSize: "14px" }}
                >
                  -
                </p>
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body pb-5">
              ...
              >
                Are you sure want to remove the current student from the list ?{" "}
              </p>
              <p
                style={{
                  fontSize: "12px",
              ...
              <p
                id="deletingName"
                style={{ fontSize: "14px", color: "black", marginTop: "-14px" }}
              ></p>
              <p
                style={{
                  fontSize: "12px",
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-lg-9 ">
            <div
              className="p-2"
              style={{ height: "100vh", background: "#F9FCFE" }}
            >
              <div className="d-flex justify-content-between mt-4">
                <p style={{color:"blue", fontWeight: "600", fontSize: "28px" }}>Students</p>
                <button 
                  ...
                  <tbody id="tableBody">
                    {tableBody.map((k, n) => (
                      <tr
                        key={n}
                        id={"tableRow" + n}
                        className="border-bottom tableRow"
                      >
                        <td className="px-4">{n + 1}</td>
                        <td style={{ color: "#242424", fontSize: "14px" }}>
                          {k.studentName}
                        </td>
                        <td>{k.classValue}</td>
                        <td id={k.result === "Passed" ? "passed" : "failed"}>
                          {k.result}
                        </td>
                        <td>{k.score}/ 100</td>
                        <td id={k.grade === "Poor" ? "poor" : "average"}>
                          {k.grade}
                        </td>
                        <td id="actionButtons">
                          <img
              ...
              <p style={{ fontSize: "12px", marginTop: "10px" }}>
                Showing {tableBody.length} of {tableBody.length} items
              </p>
            </div>
          </div>
        </div>
